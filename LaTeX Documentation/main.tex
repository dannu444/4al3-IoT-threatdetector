...
One final consideration to keep in mind when further addressing issues in the code is that feature engineering can completely compromise the ability to identify certain classes, notably class 6. Despite the correlation threshold being 90\%, this is still the case. Even ignoring this loss of class data, the classifiers that implement features show little to no improvement across all models. If further work is done to experiment with feature removal, the relationship between classes and each feature should be carefully reviewed in the decision to remove a feature since feature comparison has proved inadequate alone.
