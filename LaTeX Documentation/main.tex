...
The majority of the features for our dataset were created using the Zeek network monitoring tool and a plugin called Flowmeter. The description of these features, from \citep{ref10}, can be found in the appendix in Table \ref{tab:FeatureTab}. Features not described by \citep{ref10} are:
\begin{itemize}
...
1 = DOS_SYN_Hping, 2 = ARP_poisioning, 3 = NMAP_UDP_SCAN, 4 = NMAP_XMAS_TREE_SCAN, 5 = NMAP_OS_DETECTION, 
6 = NMAP_TCP_scan, 7 = DDOS_Slowloris, 8 = Metasploit_Brute_Force_SSH, 9 = NMAP_FIN_SCAN, 10 = MQTT_Publish, 11 = Thing_speak, 12 = Wipro_bulb
